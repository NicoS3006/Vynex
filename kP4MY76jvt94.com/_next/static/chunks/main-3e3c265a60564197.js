  ...
  [179],
  {
    ...
    73607: function (r, n, o) {
      ...
      let l = o(22866),
        addLocale = function (r) {
          for (
            var n = arguments.length, u = Array(n > 1 ? n - 1 : 0), s = 1;
            s < n;
            s++
          )
            u[s - 1] = arguments[s]
          return (0, l.normalizePathTrailingSlash)(o(67699).addLocale(r, ...u))
        }
      ;('function' == typeof n.default ||
        ('object' == typeof n.default && null !== n.default)) &&
        void 0 === n.default.__esModule &&
    ...
    16728: function (r, n, o) {
      ...
      let detectDomainLocale = function () {
        for (var r = arguments.length, n = Array(r), l = 0; l < r; l++)
          n[l] = arguments[l]
        return o(96707).detectDomainLocale(...n)
      }
      ;('function' == typeof n.default ||
        ('object' == typeof n.default && null !== n.default)) &&
        void 0 === n.default.__esModule &&
    ...
    91078: function (r, n, o) {
              ...
              l
                .replace(
                  l.pathname +
                    ...
                    String(
                      (0, L.assign)(
                        (0, L.urlQueryToSearchParams)(l.query),
      ...
      async function initialize (r) {
        ...
        {
          let { normalizeLocalePath: r } = o(11774),
            { detectDomainLocale: n } = o(96707),
            { parseRelativeUrl: l } = o(61748),
            { formatUrl: f } = o(64364)
          if (u.locales) {
            let o = l(s),
              d = r(o.pathname, u.locales)
            d.detectedLocale
              ? ((o.pathname = d.pathname), (s = f(o)))
              : (E = u.locale)
            ...
            .then(l => {
              ...
              return (null == g ? void 0 : g.Component) === u
                ? Promise.resolve()
                    ...
                    .then(r => ({ ErrorComponent: r.default, styleSheets: [] }))
      ...
      function removeLocale (r, n) {
        {
          ...
          return n && (u.startsWith('/' + s + '/') || u === '/' + s)
            ? (o.length === n.length + 1 ? '/' : '') + r.slice(n.length + 1)
            : r
        }
      }
      ;('function' == typeof n.default ||
      ...
      function detectDomainLocale (r, n, o) {
        if (r)
          for (let s of (o && (o = o.toLowerCase()), r)) {
            var l, u
            let r =
              null == (l = s.domain) ? void 0 : l.split(':')[0].toLowerCase()
            if (
              n === r ||
              o === s.defaultLocale.toLowerCase() ||
              (null == (u = s.locales)
                ? void 0
                : u.some(r => r.toLowerCase() === o))
            )
              return s
          }
      }
    ...
    32997: function (r, n, o) {
      ...
      async function matchesMiddleware (r) {
        ...
        if (!n) return !1
        let { pathname: o } = (0, C.parsePath)(r.asPath),
          l = (0, I.hasBasePath)(o) ? (0, M.removeBasePath)(o) : o,
          u = (0, L.addBasePath)((0, x.addLocale)(l, r.locale))
      ...
      function prepareUrlAs (r, n, o) {
        ...
        let h = f ? l : (0, L.addBasePath)(l),
          g = o ? stripOrigin((0, N.resolveHref)(r, o)) : u || l
        return { url: h, as: d ? g : (0, L.addBasePath)(g) }
      }
        ...
        try {
          let n = await r.fetchData(),
            o = await (function (r, n, o) {
              ...
              if (
                ...
                if (d.startsWith('/')) {
                  let n = (0, E.parseRelativeUrl)(d),
                    h = (0, k.getNextPathnameInfo)(n.pathname, {
                      nextConfig: l,
                      parseData: !0
                    }),
                  ...
                  return Promise.all([
                    ...
                    let [s, { __rewrites: f }] = l,
                      d = (0, x.addLocale)(h.pathname, h.locale)
                    if (
                      (0, b.isDynamicRoute)(d) ||
                      (!u &&
                        s.includes(
                          (0, _.normalizeLocalePath)(
                            (0, M.removeBasePath)(d),
                            o.router.locales
                          ).pathname
                        ))
                    ) {
                      let o = (0, k.getNextPathnameInfo)(
                        (0, E.parseRelativeUrl)(r).pathname,
                        { nextConfig: void 0, parseData: !0 }
                      )
                      ;(d = (0, L.addBasePath)(o.pathname)), (n.pathname = d)
                    }
                    {
                      let r = (0, S.default)(
                        d,
                    ...
                    if ((0, b.isDynamicRoute)(y)) {
                      let r = (0, R.getRouteMatcher)((0, O.getRouteRegex)(y))(d)
                      Object.assign(n.query, r || {})
                    }
                    return { type: 'rewrite', parsedAs: n, resolvedHref: y }
                  })
                }
                let n = (0, C.parsePath)(r),
                  h = (0, U.formatNextPathnameInfo)({
                    ...(0, k.getNextPathnameInfo)(n.pathname, {
                      nextConfig: l,
                      parseData: !0
                    }),
              ...
              if (g) {
                if (g.startsWith('/')) {
                  let r = (0, C.parsePath)(g),
                    n = (0, U.formatNextPathnameInfo)({
                      ...(0, k.getNextPathnameInfo)(r.pathname, {
                        nextConfig: l,
                        parseData: !0
                      }),
                      defaultLocale: o.router.defaultLocale,
      ...
      function handleHardNavigation (r) {
        ...
        if (n === (0, L.addBasePath)((0, x.addLocale)(o.asPath, o.locale)))
          throw Error(
      ...
      let Router = class Router {
            ...
            for (let _ of [r, n])
              if (_) {
                let n = (0, s.removeTrailingSlash)(
                  ...
                  y = (0, L.addBasePath)((0, x.addLocale)(n, o || this.locale))
                if (
                  n !==
        ...
        async change (r, n, o, l, u) {
          var g, y, N, D, k, U, B, z, V, X
          let Y, Q
          if (!(0, H.isLocalURL)(n))
            return handleHardNavigation({ url: n, router: this }), !1
          let $ = 1 === l._h
          $ || l.shallow || (await this._bfl(o, void 0, l.locale))
          let K =
              $ ||
              l._shouldResolveHref ||
              (0, C.parsePath)(n).pathname === (0, C.parsePath)(o).pathname,
            J = { ...this.state },
            Z = !0 !== this.isReady
          this.isReady = !0
          let ee = this.isSsr
          ...
          {
            ;(J.locale =
              !1 === l.locale ? this.defaultLocale : l.locale || J.locale),
              void 0 === l.locale && (l.locale = J.locale)
            let r = (0, E.parseRelativeUrl)(
                (0, I.hasBasePath)(o) ? (0, M.removeBasePath)(o) : o
              ),
              u = (0, _.normalizeLocalePath)(r.pathname, this.locales)
            u.detectedLocale &&
              ((J.locale = u.detectedLocale),
              (r.pathname = (0, L.addBasePath)(r.pathname)),
              (o = (0, w.formatWithValidation)(r)),
              (n = (0, L.addBasePath)(
                (0, _.normalizeLocalePath)(
                  (0, I.hasBasePath)(n) ? (0, M.removeBasePath)(n) : n,
                  this.locales
                ).pathname
              )))
            let s = !1
            ;(null == (y = this.locales) ? void 0 : y.includes(J.locale)) ||
              ((r.pathname = (0, x.addLocale)(r.pathname, J.locale)),
              handleHardNavigation({
                url: (0, w.formatWithValidation)(r),
                router: this
              }),
              (s = !0))
            let f = (0, A.detectDomainLocale)(
              this.domainLocales,
              void 0,
              J.locale
            )
            if (
              ...
              handleHardNavigation({
                url:
                  ...
                  f.domain +
                  (0, L.addBasePath)(
                    (J.locale === f.defaultLocale ? '' : '/' + J.locale) +
                      ('/' === r ? '' : r) || '/'
                  ),
                router: this
              }),
          ...
          let { shallow: er = !1, scroll: en = !0 } = l,
            ea = { shallow: er }
          this._inFlightRoute &&
            this.clc &&
            (ee ||
          ...
          let eo = (0, j.removeLocale)(
            (0, I.hasBasePath)(o) ? (0, M.removeBasePath)(o) : o,
            J.locale
          )
          this._inFlightRoute = o
          let ei = et !== J.locale
          if (!$ && this.onlyAHashChange(eo) && !ei) {
            ;(J.asPath = eo),
              Router.events.emit('hashChangeStart', o, ea),
            ...
            try {
              ...
              throw (
                ((0, h.default)(r) &&
                  r.cancelled &&
                  Router.events.emit('routeChangeError', r, eo, ea),
                r)
              )
            }
            return Router.events.emit('hashChangeComplete', o, ea), !0
          }
          let el = (0, E.parseRelativeUrl)(n),
            { pathname: eu, query: es } = el
          if (null == (g = this.components[eu]) ? void 0 : g.__appRouter)
            return (
              handleHardNavigation({ url: o, router: this }),
              new Promise(() => {})
            )
          try {
            ;[Y, { __rewrites: Q }] = await Promise.all([
          ...
          this.urlIsNew(eo) || ei || (r = 'replaceState')
          let ec = o
          eu = eu ? (0, s.removeTrailingSlash)((0, M.removeBasePath)(eu)) : eu
          let ef = (0, s.removeTrailingSlash)(eu),
            ed = o.startsWith('/') && (0, E.parseRelativeUrl)(o).pathname,
            ep = !!(
              ed &&
              ef !== ed &&
              (!(0, b.isDynamicRoute)(ef) ||
                !(0, R.getRouteMatcher)((0, O.getRouteRegex)(ef))(ed))
            ),
            eh =
              !l.shallow &&
          ...
          if (($ && eh && (K = !1), K && '/_error' !== eu)) {
            if (((l._shouldResolveHref = !0), o.startsWith('/'))) {
              let r = (0, S.default)(
                (0, L.addBasePath)((0, x.addLocale)(eo, J.locale), !0),
                Y,
                Q,
                es,
                r => resolveDynamicRoute(r, Y),
                this.locales
              )
              if (r.externalDest)
              ...
              eh || (ec = r.asPath),
                r.matchedPage &&
                  r.resolvedHref &&
                  ((eu = r.resolvedHref),
                  (el.pathname = (0, L.addBasePath)(eu)),
                  eh || (n = (0, w.formatWithValidation)(el)))
            } else
              (el.pathname = resolveDynamicRoute(eu, Y)),
                el.pathname === eu ||
                  ((eu = el.pathname),
                  (el.pathname = (0, L.addBasePath)(eu)),
                  eh || (n = (0, w.formatWithValidation)(el)))
          ...
          if (!(0, H.isLocalURL)(o))
            return handleHardNavigation({ url: o, router: this }), !1
          ;(ec = (0, j.removeLocale)((0, M.removeBasePath)(ec), J.locale)),
            (ef = (0, s.removeTrailingSlash)(eu))
          let em = !1
          if ((0, b.isDynamicRoute)(ef)) {
            let r = (0, E.parseRelativeUrl)(ec),
              l = r.pathname,
              u = (0, O.getRouteRegex)(ef)
            em = (0, R.getRouteMatcher)(u)(l)
            let s = ef === l,
              f = s ? (0, q.interpolateAs)(ef, l, es) : {}
            if (em && (!s || f.result))
              s
                ? (o = (0, w.formatWithValidation)(
                    Object.assign({}, r, {
                      pathname: f.result,
                      query: (0, W.omit)(es, f.params)
                    })
                  ))
                : Object.assign(es, em)
            else {
              let r = Object.keys(u.groups).filter(
                r => !es[r] && !u.groups[r].optional
              )
              if (r.length > 0 && !eh)
                throw Error(
                  (s
          ...
          $ || Router.events.emit('routeChangeStart', o, ea)
          ...
          try {
            ...
            if (
              ...
              ;(ef = eu = s.route || ef),
                ea.shallow || (es = Object.assign({}, s.query || {}, es))
              let r = (0, I.hasBasePath)(el.pathname)
                ? (0, M.removeBasePath)(el.pathname)
                : el.pathname
              if (
                (em &&
                  eu !== r &&
                  Object.keys(em).forEach(r => {
                    em && es[r] === em[r] && delete es[r]
                  }),
                (0, b.isDynamicRoute)(eu))
              ) {
                let r =
                    !ea.shallow && s.resolvedAs
                      ? s.resolvedAs
                      : (0, L.addBasePath)(
                          (0, x.addLocale)(
                ...
                ;(0, I.hasBasePath)(n) && (n = (0, M.removeBasePath)(n))
                {
                  ...
                  ;(J.locale = r.detectedLocale || J.locale), (n = r.pathname)
                }
                let l = (0, O.getRouteRegex)(eu),
                  u = (0, R.getRouteMatcher)(l)(
                    new URL(n, location.href).pathname
                  )
                u && Object.assign(es, u)
              }
            }
            if ('type' in s) {
            ...
            if ((s.__N_SSG || s.__N_SSP) && s.props) {
              if (s.props.pageProps && s.props.pageProps.__N_REDIRECT) {
                ...
                if (
                  ...
                  o.pathname = resolveDynamicRoute(o.pathname, Y)
              ...
              if (
                ((J.isPreview = !!s.props.__N_PREVIEW), s.props.notFound === G)
              ) {
                let r
                try {
            ...
            $ &&
              ...
              (null == (D = self.__NEXT_DATA__.props)
                ...
                ? void 0
                : N.statusCode) === 500 &&
              (null == (k = s.props) ? void 0 : k.pageProps) &&
              (s.props.pageProps.statusCode = 500)
            let g = l.shallow && J.route === (null != (U = s.route) ? U : ef),
              y = null != (B = l.scroll) ? B : !$ && !g,
              P = null != u ? u : y ? { x: 0, y: 0 } : null,
              S = {
                ...J,
                route: ef,
                pathname: eu,
            ...
            Router.events.emit('beforeHistoryChange', o, ea),
              this.changeState(r, n, o, l)
            let w =
              $ && !P && !Z && !ei && (0, F.compareRouterStates)(S, this.state)
            if (!w) {
              try {
                await this.set(S, s, P)
              } catch (r) {
              ...
              if (s.error)
                throw (
                  ($ || Router.events.emit('routeChangeError', s.error, eo, ea),
                  s.error)
                )
              J.locale && (document.documentElement.lang = J.locale),
                $ || Router.events.emit('routeChangeComplete', o, ea),
                y && /#.+$/.test(o) && this.scrollToHash(o)
            }
            return !0
          } catch (r) {
        ...
        async getRouteInfo (r) {
          ...
          try {
            ...
            if (
              (I && ('/_error' === o || '/404' === o) && (I.effect = void 0),
              E &&
                (I
            ...
            if (
              ...
              let r = (0, s.removeTrailingSlash)(I.effect.resolvedHref),
                u = await this.pageLoader.getPageList()
              if (
                (!E || u.includes(r)) &&
                ((O = r),
                (o = I.effect.resolvedHref),
                (l = { ...l, ...I.effect.parsedAs.query }),
                (f = (0, M.removeBasePath)(
                  (0, _.normalizeLocalePath)(
            ...
            let N =
              ...
              U = N.__N_SSG || N.__N_SSP
            k &&
              (null == I ? void 0 : I.dataHref) &&
              delete this.sdc[I.dataHref]
            let { props: F, cacheKey: H } = await this._getData(async () => {
              if (U) {
                if ((null == I ? void 0 : I.json) && !k)
                  return { cacheKey: I.cacheKey, props: I.json }
                let r = (null == I ? void 0 : I.dataHref)
                    ? I.dataHref
              ...
              return {
                headers: {},
                props: await this.getInitialProps(N.Component, {
                  pathname: o,
                  query: l,
                  asPath: u,
                  locale: g,
            ...
            return (
              N.__N_SSP && L.dataHref && H && delete this.sdc[H],
              this.isPreview ||
                !N.__N_SSG ||
                E ||
                fetchNextData(
        ...
        async prefetch (r, n, o) {
          ...
          let l = (0, E.parseRelativeUrl)(r),
            ...
            g = d
          if (!1 === o.locale) {
            ;(d = (0, _.normalizeLocalePath)(d, this.locales).pathname),
              (l.pathname = d),
            ...
            ;(u.pathname = s.pathname),
              (o.locale = s.detectedLocale || this.defaultLocale),
              (n = (0, w.formatWithValidation)(u))
          }
          let y = await this.pageLoader.getPageList(),
            P = n,
            A = void 0 !== o.locale ? o.locale || void 0 : this.locale,
            I = await matchesMiddleware({ asPath: n, locale: A, router: this })
          if (n.startsWith('/')) {
            let o
            ;({ __rewrites: o } = await (0, f.getClientBuildManifest)())
            let u = (0, S.default)(
              (0, L.addBasePath)((0, x.addLocale)(n, this.locale), !0),
              y,
              o,
              l.query,
              r => resolveDynamicRoute(r, y),
          ...
          ;(l.pathname = resolveDynamicRoute(l.pathname, y)),
          ...
          if (
            ((null == N ? void 0 : N.effect.type) === 'rewrite' &&
              ...
              (P = N.effect.parsedAs.pathname),
              (r = (0, w.formatWithValidation)(l))),
            (null == N ? void 0 : N.effect.type) === 'redirect-external')
          )
            return
          let D = (0, s.removeTrailingSlash)(d)
          ;(await this._bfl(n, P, o.locale, !0)) &&
            (this.components[u] = { __appRouter: !0 }),
            await Promise.all([
              this.pageLoader._isSsg(D).then(
                n =>
                  !!n &&
                  fetchNextData({
        ...
        constructor (
          ...
          ;(this.sdc = {}),
            ...
            (this.onPopState = r => {
              ...
              ;(!this.isSsr ||
                s !== (0, L.addBasePath)(this.asPath) ||
                h !== (0, L.addBasePath)(this.pathname)) &&
          ...
          let M = (0, s.removeTrailingSlash)(r)
          ;(this.components = {}),
            '/_error' !== r &&
              (this.components[M] = {
                Component: g,
          ...
          if (
            ...
            (this.domainLocales = x),
            (this.isLocaleDomain = !!(0, A.detectDomainLocale)(
              x,
    ...
    4293: function (r, n, o) {
      ...
      function prepareDestination (r) {
        ...
        for (let [n, o] of Object.entries(_))
          Array.isArray(o)
            ? (_[n] = o.map(n => compileNonPath(unescapeSegments(n), r.params)))
            : 'string' == typeof o &&
    ...
    78018: function (r) {
      ...
      ;((n = {}).d = function (r, o) {
        ...
        (I = new Date()),
        (N = function (r, n) {
          l || ((l = n), (u = r), (s = new Date()), U(removeEventListener), D())
        }),
        (D = function () {
          if (u >= 0 && u < s - I) {
            var r = {
        ...
        ($ = function (r) {
          ...
          if (o || Y.length < 10 || r.duration > n.latency) {
            if (o)
              ...
              var l = { id: r.interactionId, latency: r.duration, entries: [r] }
              ;(Q[l.id] = l), Y.push(l)
            }
            Y.sort(function (r, n) {
...
//# sourceMappingURL=main-3e3c265a60564197.js.map
